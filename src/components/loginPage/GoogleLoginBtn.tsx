...
const GoogleLoginBtn: React.FC<{ width: string; height: string }> = ({ width, height }) => {
    ...
    //이건 any말고 뭘로해야하지 ,,? 
    const handleOnSuccess = async ({ credential }: any) => {
    ...
    return (
        <GoogleOAuthProvider clientId={clientId}>
            <GoogleLogin onSuccess={handleOnSuccess} width={width}/>
        </GoogleOAuthProvider>
    );
};
